...
%% cell 2: switch to Hopf bifurcating branches
para=4; ds=0.1; figure(2); clf; aux=[]; 
p=hoswibra('tr','hpt1',ds,para,'hpt1',aux); nsteps=200;

%% cell 3: continue on Hopf branch 
p.hopf.nfloq=2;
p.hopf.jac=1; p.nc.dsmax=0.05; p.hopf.xi=0.05; p.file.smod=5; p.sw.verb=2; 
p.hopf.flcheck=1; % switch for Floquet-comp (stability of periodic orbit): 0: off, 1:floq, 2: floqps,

function [ne,ng,p,c,efl,gfl] = trgl6_disk(ndiv,r)
...
x(2,2) = 0.0; y(2,2) = act; efl(2,2) = 1;
x(2,3) =-act; y(2,3) = 0.0; efl(2,3) = 1;

x(3,1) = 0.0; y(3,1) = 0.0; efl(3,1) = 0; % third element
x(3,2) =-act; y(3,2) = 0.0; efl(3,2) = 1;
x(3,3) = 0.0; y(3,3) =-act; efl(3,3) = 1;

x(4,1) = 0.0; y(4,1) = 0.0; efl(4,1) = 0; % fourth element
x(4,2) = 0.0; y(4,2) =-act; efl(4,2) = 1;
x(4,3) = act; y(4,3) = 0.0; efl(4,3) = 1;
...
%---
 ...
 for k=1:ne     % relabel the new nodes
                % and put them in the master list
                % project boundary nodes onto a circle
                % of radius act
    for l=1:6
       x(k,l) =   xn(k,l);
       y(k,l) =   yn(k,l);

...
%        if ndone1 == 0 && ndone2 == 0 && ndone3 == 0 && ndone4 == 0;   disp('Adaptation has converged'); break;        end;
    end;
    ...
    if options.qualP < 0 && nargin == 8
   	...
   	%	bks.mvnd(:)=1;
   	%end;
   	%[tri,xy,bndmesh,Nmetric,triQ,bks] =pragadapt(tri,xy,Nmetric,bndmesh,triQ,bks,geomfunc,options,1);

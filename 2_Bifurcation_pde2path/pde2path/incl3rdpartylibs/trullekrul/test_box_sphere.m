...
for N=Nlist
    ...
    options.minA = 0;
    rand('state',0);
    [xy,tri,bndmesh,options,geomfunc] = mesh_rect3D(2*N,options,2); 
...
[fac,fac2tri,tri2fac,faca,faca2tri,tri2faca,faca2fac,edg,edga,edga2edg,edg2tri,tri2edg,tri2edga,edga2tri,fac2edg,edg2fac,edga2faca,faca2edga,faca2edg,fac2edga,fac2tri2] = ...
    bks_all3D(tri);
options.qualM = 10;

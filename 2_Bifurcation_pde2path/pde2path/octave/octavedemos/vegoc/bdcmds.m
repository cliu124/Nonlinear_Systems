...
p.nc.ilam=8; p=setlam(p,23); p.sol.ds=-2; p.nc.nsteps=50; p=findbif(p,4); 
...
%% plot the BD, max v over R  
figure(3); clf; pcmp=1; 
plotbraf('FSS','pt53',3,pcmp,'cl','k');%,'lab',[14,18,29,45]); 
plotbraf('p1','pt46',3,pcmp,'cl','b');%, 'lab',[11,16,34,38, 49,65]); 
plotbraf('p2',3,pcmp,'cl','r');%, 'lab',[23 37]); 
plotbraf('p3',3,pcmp,'cl','m');%,'lab',[8]); 
text(31,400,'FSS','fontsize',16);text(30,520,'p1','fontsize',16);
text(13.5,200,'p2','fontsize',16);text(24.5,570,'p3','fontsize',16);
xlabel('R'); ylabel('max v');
%% BD, J_{c,a} over R 

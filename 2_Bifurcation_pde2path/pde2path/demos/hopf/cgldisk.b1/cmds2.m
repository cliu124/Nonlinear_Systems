...
dir='02Dc'; p=setfn(p,dir); p.fuha.savefu(p); % set dirname and save
...
for sw=1:2
    ...
    p.sw.bifcheck=0; p.hopf.flcheck=0; p.nc.dsmax=0.21; p.hopf.ax='unif'; 
...
aux.z=[1 1+1i]; spar=6; kwnr=1; dir='02D'; 
p=twswibra(dir,'hpt2',spar,kwnr,'rw1c',aux); pause 

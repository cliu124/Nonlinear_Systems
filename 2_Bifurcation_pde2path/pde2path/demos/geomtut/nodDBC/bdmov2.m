%% script for BD-movie 
f=1; figure(fn); clf; sbd=1:3;  subplot(1,10,sbd); cla; % subplot of BD (where the marker will move) 
c=1; p2pglob.subp=[1,10,5:10]; 
plotbra('lNA',f,c,'cl','k','lsw',0);
plotbra('lNA1',f,c,'cl','b','lsw',0); 
plotbra('lNA2',f,c,'cl','r','lsw',0); 
plotbra('lNA3',f,c,'cl','m','lsw',0);
plotbra('lNA4',f,c,'cl',p2pc('g1'),'lsw',0); 
grid on; box on; xlabel('A'); 
dirlist={'lNA','lNA1','lNA2','lNA3','lNA4'}; % list of branches to move through 
slist=[2 1]; 
elist=[0 0]; fp=2; 
...
mymov2avi(M,'nodDBCl'); % export movie to disk   -aspect 19:10
p2pglob.subp=[]; 
%% CSS  SLOC2D 
close all; p=[];lx=2*pi/0.44; ly=lx/2; nx=30; ndim=2; 
...
plotbra('2DFSC','pt61',3,pcmp,'ms',ms,'lab',10,'cl','k'); 
plotbra('h2','pt50',3,pcmp,'ms',ms,'cl','r','lab',[14]); 
plotbra('h3','pt80',3,pcmp,'ms',ms,'cl','c','lab',[11]); 

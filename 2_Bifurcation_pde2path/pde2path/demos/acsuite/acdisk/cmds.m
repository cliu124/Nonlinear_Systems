...
p=[]; par=[-0.2 0 0]; p=acinit(p,5,100,par); p=setfn(p,'tr'); plotsol(p,1,1,0), pause 
...
%%
plotsol('b2','pt11',1,1,2); nola; pause; plotsol('b3','pt11',1,1,2); nola
%%
plotsol('b4','pt13',1,1,1); view(-20,60); zticks([0 0.5]); nola
%% plot lap(u)

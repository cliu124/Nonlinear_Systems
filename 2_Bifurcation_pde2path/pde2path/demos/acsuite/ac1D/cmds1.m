...
par=[1 -0.2 1 0 0]; p=acinit(5,30,par); p=setfn(p,'tr'); 
...
plotbra('b1'); plotbraf('b2'); % 2 nontrivial branches 
...
plotbra('b2','pt18',f,c,'cl','b', 'lab',10); 
plotbra('b3','pt13',f,c,'cl','m','lsw',0); ylabel('||u||_2'); 
%% c7: solution plots 
...
p=swiparf('b1','pt10','b1-cc',1); p.sol.ds=-0.1; 

...
%=====================================
 ...
 figure(1);  hold on; axis equal; set(gca,'fontsize',14)
 view([-35 18]);  box on;  axis off
...
if(ishape==1);  [ne,ng,p,c,efl,gfl] = tetra10_sphere8 (ndiv);
elseif(ishape==2);  [ne,ng,p,c,efl,gfl] = tetra10_cube8 (ndiv); end

...
% plotsol: plot component of p.u in struct p; many possible argument lists
% plotsol(p,varargin) 
...
try; tname=[p.file.pname,num2str(p.file.count)]; catch tname=[]; end 
...
if p.sol.ptype==3 && pt(1)=='h'; tname=[p.file.hpname,num2str(p.file.hcount-1)]; end
[po,~,~]=getpte(p);
switch size(po,1)
  case 1  %%%%%%%%%%%%%%%%%%% 1D %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function p=acinit(lx,nx,par) % init with prep. of mesh-adaption and usrlam
...
p.hofem.femorder=2; p=two2lob(p); % convert to qfem mesh 
...
p.plot.auxdict={'c','\lambda','gamma','d','s'}; 

...
function [fn,alv,vv,tlv,sol,tv,uv,usec,opt]=loadcp(fname)
...
Psi=p.Psi; xi=p.xi; alv=p.alv; vv=p.vv; tlv=p.tlv; sig=p.sig; 
usec=p.usec; sol=p.sols; tv=p.tv; uv=p.uv; um1=p.um1; um2=p.um2; 
end 
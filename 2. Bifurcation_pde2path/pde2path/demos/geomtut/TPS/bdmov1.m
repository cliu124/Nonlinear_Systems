...
c=[4 9]; 
plotbra('P','pt15',f,c,'cl','k','lsw',0); 
plotbra('Pb','pt20',f,c,'cl',p2pc('gr1'),'lsw',0); 
plotbra('P1','pt20',f,c,'cl','r','lsw',0); 
grid on; box on; xlabel('\delta'); ylabel('A');
dirlist={'P','Pb','P1'}; % list of branches to move through 
slist=[1 1 1]; elist=[0 0 17]; fp=2; 
...
mymov2avi(M,'P'); % export movie to disk   -aspect 19:10
p2pglob.subp=[]; 